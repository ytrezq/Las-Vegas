...
EC_GF2E::EC_GF2E(const EC_GF2E &obj)
{
    std::cout << "\n this is copy const... it is incomplete...";
    this->p = obj.p;
}
...
void EC_GF2E::printCurve()
{
    cout << "Elliptic Curve Defined by \n y^2 + " << this->a1 << "xy + " << this->a3 << "y = "
                                                                                        "x^3 + "
         << this->a2 << "x^2 + " << this->a4 << "x + " << this->a6 << " over a "
                                                                      "Fintie Field of size 2^"
         << this->p << endl;
}
...
void EC_GF2E::printCurve1()
{
    cout << "Elliptic Curve Defined by \n y^2 + " << this->a1._GF2E__rep.xrep << "xy + " << this->a3._GF2E__rep.xrep << "y = "
                                                                                                                        "x^3 + "
         << this->a2._GF2E__rep.xrep << "x^2 + " << this->a4._GF2E__rep.xrep << "x + " << this->a6._GF2E__rep.xrep << " over a "
                                                                                                                      "Fintie Field of size 2^"
         << this->p << endl;
}
