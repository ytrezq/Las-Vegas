...
// /**
//  * This is same as isDependenceFound except that this one just checks for half the
//  * range.
//  * @param arr
//  * @param count
//  * @param col1
...
//  */
// template <class T>
// bool isDependenceFound2(T *arr, ulong count, ulong &col1, ulong &col2) {
...
// template <class T, class U>
// bool isDeterminantOfSubMatrixZero_Rainbow2_2(T mat, resultData_2x2 &rD) {
...
//             if (isDependenceFound2(arr, k_end, rD.col1, rD.col2)) {
//                 rD.row1 = i;
//                 rD.row2 = j;
//                 return true;
//             }
